...
//	}
	...
	public String getBrandOriginal(String brandName) {
		...
		if (localeLanguage.equals("zh")) {
			...
			c = myDataBase.query(BRAND_TAB, null, "brand_zh =?  ",
					new String[] { brandName }, null, null, null);
		} else if (localeLanguage.equals("tw")) {
			c = myDataBase.query(BRAND_TAB, null, "brand_tw =?  ",
					new String[] { brandName }, null, null, null);
		} else {
			c = myDataBase.query(BRAND_TAB, null, "brand_en =?  ",
					new String[] { brandName }, null, null, null);
		}
	...
	public ArrayList<String> getProductsIndex(String deviceType,
			String _brandName) {
		ArrayList<String> products = new ArrayList<String>();
		Cursor c = myDataBase.query(LIST_TAB, null, "brand =? and type = ? ",
				new String[] { _brandName, deviceType }, null, null, null);
		c.moveToFirst();
		do {
